...
const DATA_DOCS: ResourceItem[] = [
  ...
  /* ---------- خرائط وخطاطات ---------- */
  {
    id: "map-quartier",
    type: "map",
    title: "رسم تخطيطي لحي سكني (مفتاح، شمال، مقياس)",
    desc: "خريطة تعليمية مبسطة للتدرب على عناصر الخريطة الأساسية وتحديد المواقع والاتجاهات.",
    level: "الجذع المشترك",
    subject: "الجغرافيا",
    ...
    action: {
      ...
      data: {
        kind: "map",
        sketch: "quartier",
        caption: "رسم تخطيطي لحي سكني — وثيقة تعليمية",
        legend: [
          { color: "#0f7c5b", label: "المدرسة" },
          { color: "#b97f26", label: "المسجد" },
          { color: "#3b82c4", label: "النهر" },
          { color: "#8a8168", label: "الشارع الرئيسي" },
        ],
        questions: ["حدّد اتجاه المسجد بالنسبة للمدرسة.", "ما المسافة التقريبية بين المدرسة والنهر اعتمادًا على المقياس؟", "عدّد عناصر الخريطة الثلاثة الأساسية."],
      },
    },
  },
  {
