 ...
 *  - "prepared": جذاذة مُعدَّة داخل الموقع من درسه المنشور + الصياغة الديداكتيكية
 *                للتوجيهات التربوية (قسم «الجذاذات المُعدَّة» المستقل). لا تُلغي
 *                الوثيقة الأصلية ولا تُعرض مكانها أبدًا.
 */
export type JadadaStatus = "original" | "model" | "pending" | "prepared";
...
export const JADADA_STATUS_META: Record<JadadaStatus, { label: string; short: string; note: string }> = {
  ...
  prepared: {
    label: "جذاذة مُعدَّة وفق التوجيهات التربوية",
    short: "مُعدَّة",
    note: "مضامينها منقولة من درس الموقع المنشور (أهدافه، إشكاليته، محاوره، مفاهيمه، خلاصاته وتقويماته)، وصياغتها الديداكتيكية (المراحل، التدبير، الدعامات، الكفايات، الحيز الزمني) وفق التوجيهات التربوية والبرامج الخاصة بتدريس مادة الاجتماعيات بالتعليم الثانوي التأهيلي. تُعرض في قسم مستقل ولا تُعوّض وثيقة الأستاذ الأصلية.",
  },
};
